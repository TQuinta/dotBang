...
post = Post.new(
  ...
  <p>Last May, I stumbled upon this exciting freelance opportunity. At the time, I was working as a full stack web developer for a <p>Stockholm-based startup. It was my first dev job, and I’d landed it barely a year earlier (which you can read more about in this article).</p>
